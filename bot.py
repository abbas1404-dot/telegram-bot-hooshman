    ...
    if "callback_query" in data:
        ...
        if cb == "cert":
            edit(
                ...
                "می‌توانید با پرداخت هزینه گواهینامه از طریق لینک زیر، "
                "سپس با مراجعه به لینک دریافت گواهینامه، فایل خود را دریافت کنید.\n\n"
                "🔹 اگر *قبلاً پرداخت را انجام داده‌اید*، "
                "مستقیماً از لینک دریافت فایل گواهینامه استفاده نمایید.",
                {
                    "inline_keyboard": [
