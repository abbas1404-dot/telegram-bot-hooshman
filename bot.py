...
# 🎛 منوی اصلی — بدون دکمهٔ "نمایش لیست" در کیبورد
main_keyboard = {
    "inline_keyboard": [
...
# 🎛 کیبورد فرعی: فقط یک دکمهٔ "نمایش لیست" — برای همهٔ پاسخ‌ها
list_button_kb = {"inline_keyboard": [[{"text": "📊 نمایش لیست", "callback_data": "show_list"}]]}

# 🎛 منوی دوره‌ها — 2 دکمه در هر سطر + دکمهٔ "نمایش لیست" در پایین
        ...
        if "callback_query" in 
            ...
            # ▶️ دوره‌های فرعی
                ...
                text = (
                    ...
                    "👇 برای بازگشت به منوی اصلی، روی دکمهٔ \"نمایش لیست\" کلیک کنید."
                )
                requests.post(
                    f"{TELEGRAM_API}/sendMessage",
                    json={
            ...
            # ▶️ سایر گزینه‌ها — همه با خط توضیح + دکمهٔ "نمایش لیست"
            responses = {
                "cert": (
                    "🎓 *دریافت گواهینامه*\n"
